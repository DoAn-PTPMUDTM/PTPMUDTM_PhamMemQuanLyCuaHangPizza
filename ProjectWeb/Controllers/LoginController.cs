...
namespace ProjectWeb.Controllers
{
    public class LoginController : Controller
    {
        ...
        private static readonly string redirectUri = "http://localhost:58761/Login/GoogleLoginCallback";
        ...
        public ActionResult doLogin(AccountViewModel user, FormCollection form)
        {
            ...
            using (var ctx = new DBContext())
            {
                ...
                if (u != null)
                {
                    ...
                    else if ("inactive".Equals(u.status))
                    {
                        Session["error"] = "Tài khoản của bạn đã xóa. Vui lòng liên hệ quản trị viên.";
                        return View("Index");
                    }
